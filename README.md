...
* NPM est le gestionnaire de package Node.js, il permet d'installer les dépendances du projet. Pour installer les dépendences, entrez la commande suivante : 
> $ npm install
* PM2 est un gestionnaire de node en mode production. Installer en entrant la commande suivante : 
